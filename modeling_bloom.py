...
class BloomAttention(nn.Module):
    def __init__(self, config: BloomV2Config):
        super().__init__()
...
BLOOM_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`BloomV2Config`]): Model configuration class with all the parameters of the model.
...
class BloomV2ForCausalLM(BloomPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"h.*.self_attention.scale_mask_softmax.causal_mask", r"lm_head.weight"]
